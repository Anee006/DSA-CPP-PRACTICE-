...
// In case of odd sized linked list, stopping condition is: (fast -> next != NULL). 
// Here, we stop at the last node of the linked list, whose "next" points to NULL.
...
int main() {
    ...
    if(mid != NULL) cout << "Middle element = " << mid->data << endl;
    ...
    if(m != NULL) cout << "Middle element = " << m->data << endl;
