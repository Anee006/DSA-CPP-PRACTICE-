...
// Return all possible palindrome partitioning of s. s contains only lowercase English letters.
...
// suppose we have a string "abaabcaba". We find that the first palindrome we get in this string is "aba". 
// So include that in ans and check for the remaining part of string i.e, "abcaba". We find that 'a' is also a palindrome 
...
bool isPalindrome(string s) {
    string s2 = s; // copy of the original string
