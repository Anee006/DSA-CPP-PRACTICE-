...
int main() {
    ...
    if(isSubtree(root, subRoot)) cout << "is subtree of another tree" << endl;
...
// Let n = number of nodes in the main tree (root) , m = number of nodes in the subtree (subRoot)
// TC = O(n x m)
// SC = O(h1 + h2) where, h1 = height of main tree , h2 = height of subtree